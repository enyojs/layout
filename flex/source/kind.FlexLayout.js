...
enyo.kind({
	...
	_getVOffset: function(oControl) {
		return (
			parseInt(this._getComputedStyle(oControl, 'padding-top').replace('px', '')) +
			parseInt(this._getComputedStyle(oControl, 'padding-bottom').replace('px', '')) + 
			parseInt(this._getComputedStyle(oControl, 'border-top-width').replace('px', '')) +
			parseInt(this._getComputedStyle(oControl, 'border-bottom-width').replace('px', ''))
		);
	},
	
	_getHOffset: function(oControl) {
		return (
			parseInt(this._getComputedStyle(oControl, 'padding-left').replace('px', '')) +
			parseInt(this._getComputedStyle(oControl, 'padding-right').replace('px', '')) + 
			parseInt(this._getComputedStyle(oControl, 'border-left-width').replace('px', '')) +
			parseInt(this._getComputedStyle(oControl, 'border-right-width').replace('px', ''))
		);
	},
